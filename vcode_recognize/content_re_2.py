...
pic_url = ('https://kyfw.12306.cn/passport/captcha/captcha-image?login_site=E&module=login&rand=sjrand&0.29060207042569175')


def get_img():
    resp = urllib.urlopen(pic_url)
    raw = resp.read()
    with open("../img/code.png", 'wb') as fp:
        fp.write(raw)

    return Image.open("../img/code.png")
